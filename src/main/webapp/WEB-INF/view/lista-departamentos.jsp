...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-4">
				<a class="btn btn-primary btn-lg" href="/departamentos/add"><i
					class="fa fa-plus"></i>Novo Departamento</a>
			</div>
						...
						<c:forEach items="${departamentos}" var="departamento">
							<tr>
								...
								<td class="actions"><a class="btn btn-warning btn-sm"
									href="/departamentos/${departamento.idMongo}/update"><i
										class="fa fa-pencil"></i> Editar</a><a
									class="btn btn-danger btn-sm"
									href="/departamentos/${departamento.idMongo}/delete"
