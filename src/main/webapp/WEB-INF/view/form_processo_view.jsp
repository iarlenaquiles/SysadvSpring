...
<form:form method="post" modelAttribute="processo"
	...
	<spring:bind path="tipo_justica">
		<div class="form-group ${status.error ? 'has-error' : ''}">
			...
			<form:select path="tipo_justica" cssClass="form-control" disabled="true" >
	...
	<spring:bind path="tipo_processo">
		<div class="form-group ${status.error ? 'has-error' : ''}">
			...
			<form:select path="tipo_processo" cssClass="form-control" disabled="true" >
				<form:option value="">Selecione</form:option>
	...
	<spring:bind path="ano_processo">
		<div class="form-group ${status.error ? 'has-error' : ''}">
			...
			<form:input path="ano_processo" type="text" cssClass="form-control" disabled="true" />
	...
	<spring:bind path="acao">
		<div class="form-group ${status.error ? 'has-error' : ''}">
			...
			<form:input path="acao" type="text" cssClass="form-control" disabled="true" />
	...
	<spring:bind path="cidade_comarca">
		<div class="form-group ${status.error ? 'has-error' : ''}">
			...
			<form:input path="cidade_comarca" type="text" cssClass="form-control" disabled="true" />
	...
	<spring:bind path="estado_comarca">
		<div class="form-group ${status.error ? 'has-error' : ''}">
			...
			<form:input path="estado_comarca" type="text" cssClass="form-control" disabled="true" />
	...
	<spring:bind path="forum">
		<div class="form-group ${status.error ? 'has-error' : ''}">
			...
			<form:input path="forum" type="text" cssClass="form-control" disabled="true" />
	...
	<spring:bind path="vara_subsecao">
		<div class="form-group ${status.error ? 'has-error' : ''}">
			...
			<form:select path="vara_subsecao" cssClass="form-control" disabled="true" >
				<form:option value="">Selecione</form:option>
	...
	<spring:bind path="procedimento">
		<div class="form-group ${status.error ? 'has-error' : ''}">
			...
			<form:select path="procedimento" cssClass="form-control" disabled="true">
				<form:option value="">Selecione</form:option>
	...
	<spring:bind path="honorario">
		<div class="form-group ${status.error ? 'has-error' : ''}">
			...
			<form:input path="honorario" type="text"
				cssClass="form-control moeda" data-prefixo="R$ " data-decimal="," disabled="true" />
